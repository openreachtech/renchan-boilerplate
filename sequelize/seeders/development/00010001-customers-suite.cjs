...
const customerRefreshTokensSeeds = [
  ...
  { id: 144101, customer_id: 100001, token_hash: 'refresh-token-hash-01-01', session_key: 'session-key-01-01', used_at: null, revoked_at: null, generated_at: new Date('2024-03-01T00:00:01.001Z'), expired_at: new Date('3000-01-01T00:00:00.000Z') },

  // one already used (rotated), one active
  { id: 144201, customer_id: 100002, token_hash: 'refresh-token-hash-02-01', session_key: 'session-key-02-01', used_at: new Date('2024-03-02T09:00:02.002Z'), revoked_at: null, generated_at: new Date('2024-03-02T00:00:02.002Z'), expired_at: new Date('3000-01-02T00:00:00.000Z') },
  { id: 144202, customer_id: 100002, token_hash: 'refresh-token-hash-02-02', session_key: 'session-key-02-02', used_at: null, revoked_at: null, generated_at: new Date('2024-05-02T00:00:02.002Z'), expired_at: new Date('3000-01-02T00:00:00.000Z') },

  // one revoked, one expired
  { id: 144301, customer_id: 100003, token_hash: 'refresh-token-hash-03-01', session_key: 'session-key-03-01', used_at: null, revoked_at: new Date('2024-03-04T03:03:03.003Z'), generated_at: new Date('2024-03-03T00:00:03.003Z'), expired_at: new Date('3000-01-03T00:00:00.000Z') },
  { id: 144302, customer_id: 100003, token_hash: 'refresh-token-hash-03-02', session_key: 'session-key-03-02', used_at: null, revoked_at: null, generated_at: new Date('2024-05-03T00:00:03.003Z'), expired_at: new Date('2024-05-04T03:03:03.003Z') },

  // active, never expires
  { id: 144401, customer_id: 100004, token_hash: 'refresh-token-hash-04-01', session_key: 'session-key-04-01', used_at: null, revoked_at: null, generated_at: new Date('2024-03-04T00:00:04.004Z'), expired_at: new Date('3000-01-04T00:00:00.000Z') },
  { id: 144501, customer_id: 100005, token_hash: 'refresh-token-hash-05-01', session_key: 'session-key-05-01', used_at: null, revoked_at: null, generated_at: new Date('2024-03-05T00:00:05.005Z'), expired_at: new Date('3000-01-05T00:00:00.000Z') },
  { id: 144601, customer_id: 100006, token_hash: 'refresh-token-hash-06-01', session_key: 'session-key-06-01', used_at: null, revoked_at: null, generated_at: new Date('2024-03-06T00:00:06.006Z'), expired_at: new Date('3000-01-06T00:00:00.000Z') },
  { id: 144701, customer_id: 100007, token_hash: 'refresh-token-hash-07-01', session_key: 'session-key-07-01', used_at: null, revoked_at: null, generated_at: new Date('2024-03-07T00:00:07.007Z'), expired_at: new Date('3000-01-07T00:00:00.000Z') },
  { id: 144801, customer_id: 100008, token_hash: 'refresh-token-hash-08-01', session_key: 'session-key-08-01', used_at: null, revoked_at: null, generated_at: new Date('2024-03-08T00:00:08.008Z'), expired_at: new Date('3000-01-08T00:00:00.000Z') },
  { id: 144901, customer_id: 100009, token_hash: 'refresh-token-hash-09-01', session_key: 'session-key-09-01', used_at: null, revoked_at: null, generated_at: new Date('2024-03-09T00:00:09.009Z'), expired_at: new Date('3000-01-09T00:00:00.000Z') },
  { id: 145001, customer_id: 100010, token_hash: 'refresh-token-hash-10-01', session_key: 'session-key-10-01', used_at: null, revoked_at: null, generated_at: new Date('2024-03-10T00:00:10.010Z'), expired_at: new Date('3000-01-10T00:00:00.000Z') },
]
